...
int main(void)
{
    ...
    if (sum_all % 10 == 0)
    {
        ...
        else if (((cc_number > 100000000000000) || (cc_number < 999999999999999)) && (cc_chksum[14] == 3))
        {
            printf("AMEX creditcard\n");
        }
        ...
        {
            printf("VISA creditcard\n");
        }
        else
        {
            printf("creditcard that belongs to no company\n");
        }
    }
    //output for invalid creditcard
    else
    {
        printf("This creditcard is invalid\n");
    }
}